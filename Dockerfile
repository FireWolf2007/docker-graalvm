...
ENV GRAALVM_URL=https://github.com/oracle/graal/releases/download/vm-1.0.0-rc2/graalvm-ce-1.0.0-rc2-linux-amd64.tar.gz \
    GRAALVM_PKG=graalvm-ce-1.0.0-rc2-linux-amd64.tar.gz \
    GRAALVM_HOME=/usr/graalvm-1.0.0-rc2
